...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('en', 'pl', 'de', 'fr', 'es', 'it', 'pt', 'nl', 'sv', 'da', 'fi', 'cs', 'sk', 'hu', 'ro', 'bg', 'hr', 'sl', 'lt', 'lv', 'et', 'el', 'mt', 'ga', 'ua');
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('default', 'exampleHero', 'category', 'categoriesGrid');
  CREATE TYPE "public"."enum_pages_hero_alignment" AS ENUM('left', 'center', 'right');
  CREATE TYPE "public"."enum_pages_hero_background" AS ENUM('none', 'light-gray', 'dark', 'gradient');
  ...
  CREATE TYPE "public"."enum_exports_locale" AS ENUM('all', 'en', 'pl', 'de', 'fr', 'es', 'it', 'pt', 'nl', 'sv', 'da', 'fi', 'cs', 'sk', 'hu', 'ro', 'bg', 'hr', 'sl', 'lt', 'lv', 'et', 'el', 'mt', 'ga', 'ua');
  ...
  CREATE TYPE "public"."enum_footer_settings_links_link_type" AS ENUM('custom', 'reference');
  CREATE TYPE "public"."enum_cookie_settings_link_type" AS ENUM('custom', 'reference');
  ...
  CREATE TABLE "pages_blocks_page_content_1" (
  	"_order" integer NOT NULL,
  	"_parent_id" uuid NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_page_content_1_locales" (
  	"title" varchar,
  	"subtitle" varchar,
  	"content" varchar,
  	"button_text" varchar,
  ...
  CREATE TABLE "pages_blocks_page_content_2_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon_id" uuid
  ...
  CREATE TABLE "pages_blocks_page_content_2_items_locales" (
  	"title" varchar,
  	"content" varchar,
  ...
  CREATE TABLE "pages_blocks_page_content_2" (
  	"_order" integer NOT NULL,
  	"_parent_id" uuid NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_page_content_2_locales" (
  	"title" varchar,
  	"subtitle" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "pages_blocks_page_content_3_audience" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "pages_blocks_page_content_3_audience_locales" (
  	"title" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "pages_blocks_page_content_3" (
  	"_order" integer NOT NULL,
  	"_parent_id" uuid NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_page_content_3_locales" (
  	"title" varchar,
  	"subtitle" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "example_block_locales" (
  	"title" varchar,
  	"description" varchar,
  	"cta_text" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages" (
  	...
  	"hero_alignment" "enum_pages_hero_alignment" DEFAULT 'center',
  	"hero_background" "enum_pages_hero_background" DEFAULT 'none',
  	"hero_cta_enabled" boolean DEFAULT false,
  	"hero_cta_url" varchar DEFAULT '/',
  	"parent_id" uuid,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "pages_locales" (
  	...
  	"hero_cta_text" varchar DEFAULT 'Learn More',
  	"meta_title" varchar,
  ...
  CREATE TABLE "_pages_v" (
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  	"parent_id" uuid,
  	"version_is_home_page" boolean DEFAULT false,
  ...
  CREATE TABLE "footer_settings_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" uuid NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_settings_links_link_type" DEFAULT 'custom',
  	"link_label" varchar,
  	"link_url" varchar,
  ...
  CREATE TABLE "footer_settings" (
  	...
  	"office_address_country" varchar,
  ...
  CREATE TABLE "cookie_settings" (
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  	"consent_version" varchar DEFAULT 1 NOT NULL,
  	"link_type" "enum_cookie_settings_link_type" DEFAULT 'custom',
  	"link_label" varchar,
  	"link_url" varchar,
  	"link_new_tab" boolean,
  	"updated_at" timestamp(3) with time zone,
  ...
  ALTER TABLE "pages_blocks_page_content_1" ADD CONSTRAINT "pages_blocks_page_content_1_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_page_content_1" ADD CONSTRAINT "pages_blocks_page_content_1_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_page_content_1_locales" ADD CONSTRAINT "pages_blocks_page_content_1_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_page_content_1"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_page_content_2_items" ADD CONSTRAINT "pages_blocks_page_content_2_items_icon_id_media_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_page_content_2_items" ADD CONSTRAINT "pages_blocks_page_content_2_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_page_content_2"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_page_content_2_items_locales" ADD CONSTRAINT "pages_blocks_page_content_2_items_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_page_content_2_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_page_content_2" ADD CONSTRAINT "pages_blocks_page_content_2_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_page_content_2_locales" ADD CONSTRAINT "pages_blocks_page_content_2_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_page_content_2"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_page_content_3_audience" ADD CONSTRAINT "pages_blocks_page_content_3_audience_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_page_content_3"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_page_content_3_audience_locales" ADD CONSTRAINT "pages_blocks_page_content_3_audience_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_page_content_3_audience"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_page_content_3" ADD CONSTRAINT "pages_blocks_page_content_3_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_page_content_3_locales" ADD CONSTRAINT "pages_blocks_page_content_3_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_page_content_3"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "example_block" ADD CONSTRAINT "example_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "example_block_locales" ADD CONSTRAINT "example_block_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."example_block"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "footer_settings_links" ADD CONSTRAINT "footer_settings_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_page_content_1_order_idx" ON "pages_blocks_page_content_1" USING btree ("_order");
  CREATE INDEX "pages_blocks_page_content_1_parent_id_idx" ON "pages_blocks_page_content_1" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_page_content_1_path_idx" ON "pages_blocks_page_content_1" USING btree ("_path");
  CREATE INDEX "pages_blocks_page_content_1_image_idx" ON "pages_blocks_page_content_1" USING btree ("image_id");
  CREATE UNIQUE INDEX "pages_blocks_page_content_1_locales_locale_parent_id_unique" ON "pages_blocks_page_content_1_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "pages_blocks_page_content_2_items_order_idx" ON "pages_blocks_page_content_2_items" USING btree ("_order");
  CREATE INDEX "pages_blocks_page_content_2_items_parent_id_idx" ON "pages_blocks_page_content_2_items" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_page_content_2_items_icon_idx" ON "pages_blocks_page_content_2_items" USING btree ("icon_id");
  CREATE UNIQUE INDEX "pages_blocks_page_content_2_items_locales_locale_parent_id_u" ON "pages_blocks_page_content_2_items_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "pages_blocks_page_content_2_order_idx" ON "pages_blocks_page_content_2" USING btree ("_order");
  CREATE INDEX "pages_blocks_page_content_2_parent_id_idx" ON "pages_blocks_page_content_2" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_page_content_2_path_idx" ON "pages_blocks_page_content_2" USING btree ("_path");
  CREATE UNIQUE INDEX "pages_blocks_page_content_2_locales_locale_parent_id_unique" ON "pages_blocks_page_content_2_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "pages_blocks_page_content_3_audience_order_idx" ON "pages_blocks_page_content_3_audience" USING btree ("_order");
  CREATE INDEX "pages_blocks_page_content_3_audience_parent_id_idx" ON "pages_blocks_page_content_3_audience" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "pages_blocks_page_content_3_audience_locales_locale_parent_i" ON "pages_blocks_page_content_3_audience_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "pages_blocks_page_content_3_order_idx" ON "pages_blocks_page_content_3" USING btree ("_order");
  CREATE INDEX "pages_blocks_page_content_3_parent_id_idx" ON "pages_blocks_page_content_3" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_page_content_3_path_idx" ON "pages_blocks_page_content_3" USING btree ("_path");
  CREATE UNIQUE INDEX "pages_blocks_page_content_3_locales_locale_parent_id_unique" ON "pages_blocks_page_content_3_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "example_block_order_idx" ON "example_block" USING btree ("_order");
  CREATE INDEX "example_block_parent_id_idx" ON "example_block" USING btree ("_parent_id");
  CREATE INDEX "example_block_path_idx" ON "example_block" USING btree ("_path");
  CREATE UNIQUE INDEX "example_block_locales_locale_parent_id_unique" ON "example_block_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "footer_settings_links_order_idx" ON "footer_settings_links" USING btree ("_order");
  CREATE INDEX "footer_settings_links_parent_id_idx" ON "footer_settings_links" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_page_content_1" CASCADE;
  DROP TABLE "pages_blocks_page_content_1_locales" CASCADE;
  DROP TABLE "pages_blocks_page_content_2_items" CASCADE;
  DROP TABLE "pages_blocks_page_content_2_items_locales" CASCADE;
  DROP TABLE "pages_blocks_page_content_2" CASCADE;
  DROP TABLE "pages_blocks_page_content_2_locales" CASCADE;
  DROP TABLE "pages_blocks_page_content_3_audience" CASCADE;
  DROP TABLE "pages_blocks_page_content_3_audience_locales" CASCADE;
  DROP TABLE "pages_blocks_page_content_3" CASCADE;
  DROP TABLE "pages_blocks_page_content_3_locales" CASCADE;
  DROP TABLE "pages_blocks_form_block" CASCADE;
  DROP TABLE "pages_blocks_form_block_locales" CASCADE;
  DROP TABLE "example_block" CASCADE;
  DROP TABLE "example_block_locales" CASCADE;
  ...
  DROP TABLE "footer_settings_links" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_hero_background";
  ...
  DROP TYPE "public"."enum_footer_settings_links_link_type";
  DROP TYPE "public"."enum_cookie_settings_link_type";`)
}
