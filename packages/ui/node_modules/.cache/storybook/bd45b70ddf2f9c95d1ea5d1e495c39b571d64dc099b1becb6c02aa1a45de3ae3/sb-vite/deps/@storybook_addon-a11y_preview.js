...
// ../../node_modules/.pnpm/@storybook+addon-a11y@9.1.20_storybook@9.1.20_@testing-library+dom@10.4.1_prettier@3.8._f2f7303a2cfa65ae152afee0813bb508/node_modules/@storybook/addon-a11y/dist/preview.mjs
...
var run = async (input = DEFAULT_PARAMETERS, storyId) => {
  let axe = (await import("./axe-EVYQIH4X.js"))?.default || globalThis.axe, { config = {}, options = {} } = input;
    ...
    if (result) {
      ...
      if (reporting.addReport({ type: "a11y", version: 1, result, status: hasViolations ? getMode() : "passed" }), getIsVitestStandaloneRun() && hasViolations && getMode() === "failed") {
        if (!vitestMatchersExtended) {
          let { toHaveNoViolations } = await import("./matchers-7Z3WT2CE-FILTE5MP.js");
