    ...
    <section className="py-16">
      <Container size="md">
        ...
        {buttonText && buttonLink ? (
          <a
            href={buttonLink}
            className="inline-flex items-center rounded-md px-6 py-3 text-sm font-semibold text-white transition-colors"
            style={{ backgroundColor: 'var(--template-color-primary)' }}
          >
            {buttonText}
          </a>
        ) : null}
